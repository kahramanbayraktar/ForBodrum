...
export function TopBar({ notificationCount = 0, dictionary }: TopBarProps) {
  return (
    <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-sm border-b border-border safe-area-top">
      <div className="flex items-center justify-between h-14 px-4 mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif font-bold text-xl text-bodrum-blue tracking-tight">
            {dictionary?.common?.for_bodrum || "ForBodrum"}
          </span>
        </div>
